...
class Dialog1(ui.Window):
	...
	def BuildWindow(self):
		...
		self.Board.Show()
		self.comp = Component()
		self.btnActiv = self.comp.Button(self.Board, 'Attiva', '', 204, 28, self.ActivFunc, 'd:/ymir work/ui/public/middle_button_01.sub', 'd:/ymir work/ui/public/middle_button_02.sub', 'd:/ymir work/ui/public/middle_button_03.sub')
		self.btnDeactiv = self.comp.Button(self.Board, 'Disattiva', '', 204, 47, self.DeactivFunc, 'd:/ymir work/ui/public/middle_button_01.sub', 'd:/ymir work/ui/public/middle_button_02.sub', 'd:/ymir work/ui/public/middle_button_03.sub')
		self.btnDeactiv.Hide()
		self.btnYang = self.comp.Button(self.Board, 'Solo Yang', '', 30, 83, self.btnYang_func, 'd:/ymir work/ui/public/middle_button_01.sub', 'd:/ymir work/ui/public/middle_button_02.sub', 'd:/ymir work/ui/public/middle_button_03.sub')
		self.btnEvery = self.comp.Button(self.Board, 'Tutto', '', 90, 83, self.btnEvery_func, 'd:/ymir work/ui/public/middle_button_01.sub', 'd:/ymir work/ui/public/middle_button_02.sub', 'd:/ymir work/ui/public/middle_button_03.sub')
		self.btnCredits = self.comp.Button(self.Board, 'CrashMap', '', 204, 69, self.btnCredits_func, 'd:/ymir work/ui/public/middle_button_01.sub', 'd:/ymir work/ui/public/middle_button_02.sub', 'd:/ymir work/ui/public/middle_button_03.sub')
		self.btnKick = self.comp.Button(self.Board, '', '', 31, 106, self.onClickKick, 'd:/ymir work/ui/public/close_button_01.sub', 'd:/ymir work/ui/public/close_button_02.sub', 'd:/ymir work/ui/public/close_button_03.sub')
		self.lblModus = self.comp.TextLine(self.Board, 'Modalitŕ Disponibili:', 30, 68, self.comp.RGB(0, 229, 650))
		self.title = self.comp.TextLine(self.Board, 'PickUpBot by !Beni!@e*pvp - Fix by Freeman', 30, 11, self.comp.RGB(255, 255, 0))
		...
		if not offical_server:
			...
			self.lblOfficalServer = self.comp.TextLine(self.Board, 'Server Ufficiale', 30, 29, self.comp.RGB(0, 255, 255))
